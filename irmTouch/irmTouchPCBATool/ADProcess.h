...
public:
	...
	void __fastcall LogADData(FILE *fp, void *Head, uint8_t *Data,
		bool ClcCheckSum);
	void __fastcall LogDebugADData(FILE *fp, DebugHead_t *Head, uint8_t *Data);
	void __fastcall LogADDataV4(FILE *fp, void *Head, uint8_t *Data,
		bool ClcCheckSum);
	...
	void __fastcall ProcessAD(uint8_t ver, uint8_t EnvFlag, uint8_t *Data,
		uint32_t Len);
...
const String LogFileMagicStringV2 = "AD Log Data Version 2.0";
// we add aux scan param
