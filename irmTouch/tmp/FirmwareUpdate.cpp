...
const unsigned char TableA[] = {
	, 
};

const unsigned char TableB[] = {
	, 
};
...
bool __fastcall TFormUpdate::InterpretFile(String FileName)
{
	...
	else
	{
		...
		if(BootParam.BootLoaderVersion == 16 || BootParam.BootLoaderVersion == 18) {
        	memcpy(RomCtrl, &UpdateCtrl.MainFlash[0xE800 - 64], 64);
			RomCtrl[64] = '\0';
		} else {
			memcpy(RomCtrl, &UpdateCtrl.MainFlash[UpdateCtrl.AppEndAdd - 64], 64);
			RomCtrl[64] = '\0';
		}
		...
		crc = CRC32((uint32_t *)(UpdateCtrl.MainFlash + UpdateCtrl.AppStartAdd), (UpdateCtrl.AppSize)/4 -1);
		...
		Msg.sprintf(L"固件版本：%d.%d.%d", iTemp/1000, iTemp/10%100, iTemp%10);
...
void __fastcall EncodeBuf(unsigned char *Out, unsigned char *In, unsigned int Len)
{
	unsigned int i;
...
void __fastcall DecodeBuf(unsigned char *Out, unsigned char *In, unsigned int Len)
{
	unsigned int i;
...
bool __fastcall CheckFileSign(String FileName)
{
	...
	if(!CryptAcquireContext(&hProv, L"JYEST", NULL, PROV_RSA_FULL, 0))	// 连接名为JYEST的CSP，接受它的句柄放入hProv
	{
		if (GetLastError() == (DWORD)NTE_BAD_KEYSET)   						//不存在的话就创建
		{
			if(!CryptAcquireContext(&hProv, L"JYEST", NULL, PROV_RSA_FULL, CRYPT_NEWKEYSET))
			{
	...
	do
	{
		if(FileLen < BUFFER)
		{
			dReadLen = fread(pBuffer, 1, FileLen, sourceFile); //sourceFile->Read(pBuffer,BUFFER);
		}
		else
		{
			dReadLen = fread(pBuffer, 1, BUFFER, sourceFile); //sourceFile->Read(pBuffer,BUFFER);
		}
...
void __fastcall TFormUpdate::ButtonUpdateClick(TObject *Sender)
{
	...
	if(MainForm->HIDSendThread->Connected == TRUE)
	{
		...
		if(BootParam.AppSta != APP_EMPTY)
		{
			...
			{
				Msg.cat_printf(L"\n忽略以上警告,强制升级?");
				if(MessageBox(NULL, Msg.t_str(), L"强制升级?", MB_OKCANCEL | MB_ICONWARNING) == IDCANCEL)
					return;
			}
		}
		...
		if(MainForm->HIDSendThread->SubmitTask( TYPE_APP,
										  UpdateCtrl.AppSize,
										  UpdateCtrl.MainFlash + UpdateCtrl.AppStartAdd,
										  &Head) )
		{
...
void __fastcall TFormUpdate::UpdateFlashParam(uint8_t BootVersion, uint8_t FlashSize)
{
	...
	else if(BootVersion < 71)	//stm32f30x
	{
		...
		fp->EndAreaSize = fp->ScanTabSize + fp->ParamSize + fp->SecretSize + fp->SerialSize;

		fp->AppSize = fp->FlashSize - fp->BootSize - fp->UserParamSize - fp->CalibrateSize - fp->EndAreaSize;
	}
	...
	else if(BootVersion < 90)	//at32f403    8.0~8.9
	{
		...
		fp->ReserveStartAdd = fp->SecretStartAdd + fp->SecretSize;       // not exactly
	...
	else if(BootVersion == 100) //stm32f4xx   V10.0        仅出过一个框     TMD还出问题了  2013.3.12
	{
    	fp->FlashSize = FlashSize*32*1024;
		fp->BootSize = 16*1024;
	...
	else	// >= 10.2
	{
		...
		fp->ReserveStartAdd = fp->SerialStartAdd + fp->SerialSize;       // not exactly
		fp->ReserveSize = 28*1024;
...
void __fastcall TFormUpdate::DispSta(void)
{
	...
	if(BootParam.HardwareVer != 0xFFFF)
	{
		...
		//{
			Msg.sprintf(L"硬件版本：%d.%d", BootParam.HardwareVer/100, BootParam.HardwareVer%100);
		//}
		//else
		//{
	...
	Msg.sprintf(L"触摸屏 (%4X:%4X) ", MainForm->HIDSendThread->usVid, MainForm->HIDSendThread->usPid);
...
void __fastcall TFormUpdate::Timer1Timer(TObject *Sender)
{
	...
	switch(step) {
		case 0: break;	//wait privious command
...
//				}
//				break;
		case 1: MainForm->HIDSendThread->SubmitCmd(BOOT_CMD_SW_MODE, NULL, 0); break;
		case 2: MainForm->HIDSendThread->SubmitCmd(BOOT_CMD_GET_STA, NULL, 0); break;
		case 3: MainForm->HIDSendThread->SubmitCmd(BOOT_CMD_SW_MODE, NULL, 0); break;
		case 4: if(BootParam.BootLoaderVersion == 16 || BootParam.BootLoaderVersion == 18) {
					step += 1;
				} else {
					MainForm->HIDSendThread->SubmitCmd(BOOT_CMD_GET_STA, NULL, 0);
				}
				break;
		case 5: break;//MainForm->HIDSendThread->SubmitCmd(BOOT_CMD_SW_MODE, NULL, 0); break;
		case 6: MainForm->HIDSendThread->SubmitCmd(BOOT_CMD_READ_SERIAL, NULL, 0); break;
		case 7: MainForm->HIDSendThread->SubmitCmd(BOOT_CMD_CPUID, NULL, 0);  break;
		case 8: MainForm->HIDSendThread->SubmitCmd(BOOT_CMD_READ_PARAM, NULL, 0);   break;
